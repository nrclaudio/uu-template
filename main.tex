...
% Open license, but please give credit when appropriate %
...
% this reads as: include this image with a width of 100% of the text width, if it's too big  % of an image you can play around with this parameter
% \centering
...
\begin{document}
\captionsetup{labelfont=bf, labelsep = period, font = it}
